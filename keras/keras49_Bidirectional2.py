...
#                return_sequences=True))  #40800
model.add(Bidirectional(LSTM(350, return_sequences=True), input_shape=(4,1)))  #81600
model.add(GRU(units=100, input_shape=(4,1)))  #40800
...
mcp = ModelCheckpoint(monitor='loss', mode = 'auto', verbose = 1,
                        save_best_only=True,
                        filepath = filepath + 'k49_2' + date +'_'+ filename)
...
# [100, 107]의 결과 :  [100, 107]의 결과 :  [[100.00334 ][100.9943][101.97964][102.95564][103.915665][104.86282][105.793724]]
